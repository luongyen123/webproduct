	     ...
	     <div class="box-right">
			    ...
			    <div class="content-box">
			         ...
			         <div class="support">
                    <strong>Hoang dieu trinh</strong>				
          <a rel="nofollow" href="ymsgr:sendIM?tuyenht90">
		    <img style="width:160px"src="<?php echo public_url()?>/site/images/cute.jpg">
	      </a>
	      
	      <p>
	         <img style="margin-bottom:-3px" src="<?php echo public_url()?>/site/images/phone.png"> 016845689 </p>
	      
		  <p>
			<a rel="nofollow" href="mailto:hoangvantuyencnt@gmail.com">
			    <img style="margin-bottom:-3px" src="<?php echo public_url()?>/site/images/email.png"> Email: hoangdieutrinh96@gmail.com
		    </a>
		  </p>
		  <p>
			<a rel="nofollow" href="skype:tuyencnt90">
			     <img style="margin-bottom:-3px" src="<?php echo public_url()?>/site/images/skype.png"> Skype: hoangdieutrinh</a>
		</p>	
		</div>			        </div>
          </div>
       <!-- End Support -->
         ...
         <!-- The news -->
	          <div class="box-right">
			    ...
			    <div class="content-box">
			       <ul class="news">
			            			            <li>
			                <a href="<?php echo public_url()?>/site/news/view/4.html" title="Mỹ tăng cường không kích Iraq">
		 ...
		 <!-- The Fanpage -->
	       <div class="box-right">
			    ...
			    <div class="content-box">
					...
					</script><div id="histats_counter_6634" style="display: block;"><a href="http://www.histats.com/viewstats/?sid=2138481&amp;ccid=401" target="_blank"><canvas id="histats_counter_6634_canvas" width="119" height="81"></canvas></a></div></a>
