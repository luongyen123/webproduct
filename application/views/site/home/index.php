             ...
             <div class="tittle-box-center">
		      ...
		      <div class="box-content-center product"><!-- The box-content-center -->
                       ...
                       <p class="price">
                        ...
                        <center>
                          <div class="raty" style="margin: 10px 0px; width: 100px;" id="9" data-score="4" title="good"><img src="<?php echo base_url();?>/site/raty/img/star-on.png" alt="1" title="good">&nbsp;<img src="<?php echo base_url();?>/site/raty/img/star-on.png" alt="2" title="good">&nbsp;<img src="<?php echo base_url();?>/site/raty/img/star-on.png" alt="3" title="good">&nbsp;<img src="<?php echo base_url();?>/site/raty/img/star-on.png" alt="4" title="good">&nbsp;<img src="<?php echo base_url();?>/site/raty/img/star-off.png" alt="5" title="good"><input type="hidden" name="score" value="4" readonly="readonly"></div>
                        </center>
                       <div class="action">
